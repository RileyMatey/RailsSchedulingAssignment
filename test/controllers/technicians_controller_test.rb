...
class TechniciansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create technician" do
    assert_difference("Technician.count") do
      post technicians_url, params: { technician: { id: @technician.id, name: @technician.name } }
    end
  ...
  test "should update technician" do
    patch technician_url(@technician), params: { technician: { id: @technician.id, name: @technician.name } }
