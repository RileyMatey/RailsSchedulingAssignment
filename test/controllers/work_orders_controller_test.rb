...
class WorkOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create work_order" do
    assert_difference("WorkOrder.count") do
      post work_orders_url, params: { work_order: { duation: @work_order.duation, location_id: @work_order.location_id, price: @work_order.price, technician_id: @work_order.technician_id, time: @work_order.time } }
    end
  ...
  test "should update work_order" do
    patch work_order_url(@work_order), params: { work_order: { duation: @work_order.duation, location_id: @work_order.location_id, price: @work_order.price, technician_id: @work_order.technician_id, time: @work_order.time } }
